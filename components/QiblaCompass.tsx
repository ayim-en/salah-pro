    ...
    <View className="w-80 h-80 items-center justify-center">
      ...
      >
        ...
        <View className="absolute right-2">
          <Text className="text-lg font-semibold text-gray-700">E</Text>
        </View>
        <View className="absolute bottom-2">
          <Text className="text-lg font-semibold text-gray-700">S</Text>
        </View>
        <View className="absolute left-2">
          <Text className="text-lg font-semibold text-gray-700">W</Text>
        </View>
      </View>
